        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M12 2C6.477 2 2 6.145 2 11.243c0 2.908 1.436 5.507 3.677 7.197V22l3.374-1.848A11.46 11.46 0 0012 20.486c5.523 0 10-4.145 10-9.243C22 6.145 17.523 2 12 2zm1.082 12.578l-2.52-2.674-4.92 2.674 5.4-5.72 2.58 2.674 4.86-2.674-5.4 5.72z" />
            </svg>
            Messenger
          </a>
          <a
